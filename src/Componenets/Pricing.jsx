...
const Pricing = () => {
  const handleScrollToContact=()=>{
    const targetElemet=document.getElementById('contact');
    if(targetElemet){
      window.scrollTo({
    ...
    <div className="bg-[#f7f8fc] pt-32" id="pricing">
      <div className="container mx-auto px-8">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold font-secondary mb-3">Perfect for small and larger Brands</h2>
          <p className=" text-lg mb-12 md:w-2/3 mx-auto">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit rerum
            quia dolorem unde voluptate neque sequi assumenda enim eius
